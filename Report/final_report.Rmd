...
#meansd.GSE15744.vsnrma <- as.grob(meansd.GSE15744.vsnrma$gg)
#boxplot.GSE15744.vsnrma <- as.grob(boxplot.GSE15744.vsnrma)

#str(meansd.GSE15744.vsnrma)
OC_normalization_plot = arrangeGrob(grobs = list(meansd.GSE15744.vsnrma$gg, #boxplot.GSE15744.vsnrma,
                                                 scatterplot.GSE15744.vsnrma), nrow=1, widths = c(3, #3,
                                                                                                  3), heights = c(3))

OC_normalization_plot_output = as_ggplot(OC_normalization_plot) +
  draw_plot_label(label = c("A",# "B", 
                            "C"), size = 15, x = c(0.03,# 0.35, 
                                                   0.63), y = c(0.13,# 0.13,
                                                                0.13)) 
...
To make sense out of the intensity values they need to be associated to common data with known properties. We applied the data frame *ensembl_103.txt* provided by Mrs Dr Dinkelacker, to annotate our data and yield the appropriate transcript ID for the Probe ID of the microarray. To annotate for TRAs, we applied another data frame by Mrs Dr Dinkelacker called *tra.2017.human.gtex.5x.table.tsv*.
...
```{r further-silent-Data-Cleaning, eval = FALSE}
...
We acquired the data from the original paper from the supplemental materials. We imported it into a data frame annotated it with the use of our dataset to filter for TRAs.
```{r}
