...
Gene which didn't belong in those groups were declared as not differentially expressed. The genes with an adjusted P-value smaller then 0.01 were further used.

```{r}
load("/Users/joshuaeigenmann/Documents/GitHub/2022-topic-04-team-01/Report/Plots/Volcano.pdf")
```
