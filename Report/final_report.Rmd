...
Our expression data was gained from embryos between weeks 4 to 9, hence it's essential to know what happens in organogenesis during these weeks in the most prominent organs: the liver, the gonads, the spleen, the heart, the stomach, the skin, the skeletal muscles and the brain.


## TRAs as a tool to gain insight into embryonic development {#intro-tra}


The next organ are the gonads, their progenitors develop next to the progenitor of the kidney and are made up of three different cellforms, the coelomic epithelium form, the progenitor kidney form and the germline cell form. Those cells move to the gonades between weeks 5 to 6. They develop into ovaries and testes at week 7 (Benninghoff 1993). 
...
The shape of the heart resembles a tube at week 3. The different heart parts develop at week 4 due to curvation and growth, also the ventricles are created. The fundamental layout of the heart is already present by weeks 4 to 5. Further remodeling takes place until week 7 ( Ulfig 2009; Hikspoors et al. 2022)

The stomach develops from the midgut. The primitive gut divides into foregut, midgut and hindgut at week 4. Furthermore a 90 degree rotation along the axis of mesentery vessels takes place at week 8. As a result, the small gut is now on the right side of the midgut and the colorectum is on the left (Kluth et al. 2013).

Skin development starts immediately after gastrulation at week 3. The ectoderm further develops to the nervous system and skin epithelium. The epidermal differentiation of these ectoderm cells is illustrated by gene expression of keratins. Adhered cells (periderm) create a protective layer for the ectoderm between weeks 4 to 8. Antigen presenting immune cells, the Langerhans cells, are notable at week 6 (Hu et al. 2018).

The skeletal muscles, e.g. some head muscles differentiate form mesoderm. First myotubes with central nuclei, where created by the fusion of myotubes between week 10 to 13. Typical muscle proteins develop in the following weeks (Romero et al. 2013). 

Major parts of the brain are developed by week 9. Characteristic neuronal development steps take place during this period, e.g. neuronal proliferation, neuronal differentiation, neuronal immigration and synapse formation (National Research Council and Institute of Medicine 2009; Müller & Hassel 2018). Many signals influence the development of the brain e.g. chemokines.
...
#sum(!is.na(paper_df_ann$ensembl.transcript)) 
...
annotate_figure(Paper_clustering_plot_output, top = text_grob("Intensity values of transcripts determined to be\ndifferentially expressed by authors of the paper", color = "black", face = "bold", size = 16))


```


We repeated the same plot with transcripts, which we determined as differentially expressed by our *limma* analysis and the results were highly similar. The Figure can be found on our github ().
...
Principal component analysis (PCA) was performed on a matrix containing all differentially expressed genes throughout weeks 4 to 9. This was performed to reduce dimension while keeping most of the data's variance to gain better insight on the expression of genes between those weeks.
...
legend('bottomright', legend = c('ENST00000399848 (LDLRAD4)','ENST00000432997 (KCNMB2)','ENST00000452583 (KCNMB2)','ENST00000241274 (SLITRK3)','ENST00000475390 (SLITRK3)'), col=c('black','red','green','blue','orange'), pch=16, cex=0.8,title="Expressed genes")
```
...
Finally ENST00000577440 encoding for SEPTIN4 (septin 4) was identified. SEPTIN4 may regulate cytoskeletal organization. A defect in septin function disturbs cytokinesis. ENST00000577440 is connected to Cerebellar Hemisphere and shows an increase between weeks 7 to 9.
...
In contrast to our *limma* analysis to generate data with biological relevance, the authors of the original paper of our data set used *One-way analysis of variance* to acquire differential expressed genes. We compared both data subsets by clustering and plotting the overlapping Intensity values (Figure \@ref(paper-trends-cluster)). By looking at the trends of the cluster for up and down regulated gene expression
