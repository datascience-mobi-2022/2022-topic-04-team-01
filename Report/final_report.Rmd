...
To determine the number of transcripts which overlap between the data of the paper and our data, we plotted a Venn diagram (suppl. Fig. \@ref(fig:Venn-Diagram)). The intersection showed a number of transcripts worthy for further analysis.
