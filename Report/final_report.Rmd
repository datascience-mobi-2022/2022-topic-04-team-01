...
```{r importing-the-data-from-harddrive}
...
>>>>>>> 1b752cc3fa1eed0b9f3aded69956577977c5a218
...
## No TRAs could be identified as key biomarkers for the development of individual organs

Principal component analysis helped to identify transcripts that have a high contribution to our data's variance. The high variance explained by PCA1 alone made it possible to focus our further analysis only on this PCA. Ranking the transcripts according to their contribution led us to identify the three proteins LDLRAD4, KCNMB2 and SLITRK3 as main contributors to our data's variance over the weeks.\ Connecting our findings achieved trough PCA with the TRA data to identify key biomarkers for the development of individual organs throughout the weeks has yet to be successful. The information gained trough PCA was not sufficient enough to determine specific TRAs that could be used to proof our hypotheses. More indepth analyzation needs to be performed to determine wether PCA is not a sufficient method to identify TRAs that can be used as key biomarkers for development, or if TRAs in general can not be used as key biomarkers for tevelopment, therfore disproofing our hypotheses. 
...
GTEX 2013, (2013), The Genotype-Tissue Expression (GTEx) project, GTEx Consortium, Nat Genet. 45, 580-5.

GTEX 2015, (2015), Human genomics, The Genotype-Tissue Expression (GTEx) pilot analysis: multitissue gene regulation in humans, GTEx Consortium, Science 348, 648-60.
...
```{r Volcano-Plot,fig.height= 3.5, fig.height=3.5fig.cap="Volcanoplot for differential gene expression between week 4 and 9. The adjusted P-value boundary was set at 0.01. The logFC boundarys were -1 and 1."}
