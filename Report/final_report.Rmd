...
#Quellen Liver
@Book{Liver,
  title = {Pädiatrische Gastroenterologie, Hepatologie und Ernährung. Embryologie und Physiologie der Leber.},
  author = {{Deutsch,J.}},
  address = {Berlin, Deutschland},
  year = {2013},
  url = {https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7498810/},
}
#Deutsch J.  2013. Embryologie und Physiologie der Leber. Pädiatrische Gastroenterologie, Hepatologie und Ernährung. 375–87. German.

# Quellen Gonades
@Book{Gonades,
  title = {Makroskopische Anatomie, Embryologie und Histologie des Menschen. 15. Auflage.},
...
#Quellen Spleen
@article{Spleen1,
  title = {Development of the Spleen},
  author = {{James F., Jones M.D.}},
  address = {©Georg Thieme Verlag Stuttgart, New York},
  year = {1933},
  url = {Lyrnphology 16 (1983) 83-89},
}
#James F. Jones, M.D. 1983. Development of the Spleen. Lyrnphology 16 83-89.Georg Thieme Verlag Stuttgart, New York
@article{Spleen2,
  title = {The human fetus and newborn: development of the immune response.},
  author = {{Hayward AR.}},
  year = {1983},
}
#Hayward AR. 1983. The human fetus and newborn: development of the immune response. Birth Defects Orig. Artic. Ser. 19(3):289-94. PMID: 6606446.

#Quellen Herz
@Book{Heart1,
  title = {Kurzlehrbuch Embryologie, 2. Auflage},
  author = {{Ulfig N.}},
  address = {©Georg Thieme Verlag Stuttgart · New York},
  year = {20009},
  url = {},
...
@Article{Heart2,
  ...
  author = {{Hikspoors, J.P.J.M., Kruepunga, N., Mommen, G.M.C. et al.}},
  address = {Commun Biol 5, 226},
  year = {20022},
  url = {https://doi.org/10.1038/s42003-022-03153-x},
}
#Hikspoors, J.P.J.M., Kruepunga, N., Mommen, G.M.C. et al. 2022. A pictorial account of the human embryonic heart between 3.5 and 8 weeks of development. Commun Biol 5, 226. https://doi.org/10.1038/s42003-022-03153-x

#Quellen Stomach
@Article{Stomach,
  title = {A pictorial account of the human embryonic heart between 3.5 and 8 weeks of development.},
  author = {{Kluth D., Jaeschke-Melli S., Fiegel H.}},
  address = {Seminars in Pediatric Surgery},
  year = {20003},
  url = {https://doi.org/10.1053/j.sempedsurg.2003.08.009},
}
#Kluth D., Jaeschke-Melli S., Fiegel H. 2003.The embryology of gut rotation. Seminars in Pediatric Surgery. 12(4) (275-279).

#Quellen Skin
@Article{Skin,
  title = {Embryonic skin development and repair.},
  author = {{Hu MS., Borrelli MR., Hong WX., Malhotra S., Cheung ATM., Ransom RC., Rennert RC., Morrison SD., Lorenz HP., Longaker MT.}},
  address = {Organogenesis},
  year = {2018 Jan 2;14(1) (46-63)},
  url = {https://doi.org/10.1053/j.sempedsurg.2003.08.009},
}
#Hu MS., Borrelli MR., Hong WX., Malhotra S., Cheung ATM., Ransom RC., Rennert RC., Morrison SD., Lorenz HP., Longaker MT. 2018. Embryonic skin development and repair. Organogenesis.  14(1) (46-63).


#Quellen Skeletal Muscles
@Book{Skeletal_Muscles,
  title = {Pediatric Neurology Part III.Chapter 137 - Main steps of skeletal muscle development in the human: Morphological analysis and ultrastructural characteristics of developing human muscle},
  author = {{Romero N. B., Mezmezian M., Fidziańska A.}},
  address = {Elsevier. Handbook of Clinical Neurology 113 (1299-1310)},
  year = {2013)},
  url = {https://doi.org/10.1053/j.sempedsurg.2003.08.009},
}
#Romero N. B., Mezmezian M., Fidziańska A. 2013. Pediatric Neurology Part III. Chapter 137 - Main steps of skeletal muscle development in the human: Morphological analysis and ultrastructural characteristics of developing human muscle. Handbook of Clinical Neurology 113 (1299-1310). Elsevier.
...
@Book{Brain2,
  title = {Entwicklungsbiologie und Reproduktionsbiologie des Menschen und bedeutender Modellorganismen. 6. Auflage.},
  author = {{Müller W. A., Hassel M.}},
  address = {Berlin, Deutschland},
  year = {2018)},
  url = {https://doi.org/10.1007/978-3-662-55534-7},
}
...
# Quellen Chemokine
@Article{Chemokin1,
  title = {Expression of chemokine receptor CXCR4 during chick embryo development.},
  author = {{Yusuf F., Rehimi R., Dai F.,Brand-Saberi B.}},
  address = {Anatomy and Embryology 210(1) (35-41)},
  year = {2005)},
  url = {https://link.springer.com/article/10.1007/s00429-005-0013-9},
}
#Yusuf F., Rehimi R., Dai F.,Brand-Saberi B. 2005. Expression of chemokine receptor CXCR4 during chick embryo development. Anatomy and Embryology 210(1) (35-41)
@Article{Chemokin2,
  title = {CXCL12/CXCR4 signalling in neuronal cell migration},
  author = {{Tiveron M.-C., Cremer H.}},
  address = {Current Opinion in Neurobiology 18(3) (237-244)},
  year = {2005)},
  url = {https://link.springer.com/article/10.1007/s00429-005-0013-9},
}
#Tiveron M.-C., Cremer H. 2008. CXCL12/CXCR4 signalling in neuronal cell migration. Current Opinion in Neurobiology 18(3) (237-244).

#Quellen TRA
@Dissertation{TRA1,
  title = {Chromosomal clustering of tissue restricted antigens},
  author = {{Dinkelacker M}},
  address = {},
  year = {2019)},
  url = {https://archiv.ub.uni-heidelberg.de/volltextserver/27270/5/Doktorarbeit_Maria_Dinkelacker.pdf},
}
#Dinkelacker M. 2019. Chromosomal clustering of tissue restricted antigens.
@Book{TRA2,
  title = {aneway Immunologie. 9. Auflage},
  author = {{Murphy K., Weaver C.}},
  address = {Berlin, Deutschland},
  year = {2018)},
  url = {https://link.springer.com/content/pdf/10.1007/978-3-662-56004-4.pdf},
}
...
<<<<<<< Updated upstream
HEAD
Our expression data was gained from embryos between weeks 4 to 9, hence it's essential to know what happens in organogenesis during these weeks in the most prominent organs: the liver, the gonades, the spleen, the heart the skeletal muscles and the brain.

=======
=======

##Something subtitle tissues {#intro-tissues}
...
>>>>>>> fa2a7ca9c83164580a3147451e8ce27862ff6a47

Let us start with the liver. At week 4, the liver sprout further develops to hepathocytes and intrahepathic gallic pathways while staying in close contact to the further outbranching vitelline veins. Between weeks 5 to 9 the production of gallic acid starts. Furthermore, glykogengranula develop at week 8 and glykogensynthesis starts at week 9. Between weeks 8 and 9 the expression of cytochrome-P450-enzyme starts (Deutsch, 2013).
...
The next organ are the gonads, their progenitors develop next to the progenitor of the kidney and are made up of three different cell forms, the coelomic epithelium form, the progenitor kidney form and the germline cell form. Those cells move to the gonads in weeks 5 to 6. They develop into ovaries and testes in week7 (Benninghoff; 1993). 
=======
...
The spleen first appears in the mesogastrium at week 6. Blood vessels appear in the organ in weeks 8 to 9 (James; 1983). The spleen plays an important role in the immunesystem. For example, b-lymphocytes are present in the spleen by week 12 (Hayward; 1983).

*Quellen: https://journals.uair.arizona.edu/index.php/lymph/article/view/20479/20088; https://pubmed.ncbi.nlm.nih.gov/6606446/*

The shape of the heart resembles a tube at week 3. The different heart parts develop at week 4 due to curvation and growth and the ventricles are created. The fundamental layout of the heart is already present by weeks 4 to 5. Further remodeling takes place untill week 7 ( Ulfig; 2009; Hikspoors; 2022)
...
The stomach develops from the midgut. The primitive gut devides into foregut, midgut and hindgut at week 4. Furthermore a 90 degree rotation along the axis of mesentery vessels takes place at week 8. As a result, the small gut is now on the right side of the midgut and the colorectum is on the left (Kluth; 2013).

HEAD
The skeletal muscles start developing at week 5. Skeletal muscles evolve from the myogenic progenitor cells of the myotome and dermomyotome located in the somites. As part of skeletal myogenesis a complex molecular network of independant pathways is reasonable for the development of myogenic progenitor cells into myofibers.
=======
*Quellen: https://www.sciencedirect.com/science/article/pii/S1055858603000581?casa_token=hE7Ts9rUPgcAAAAA:pOCIFzjRX__R65pzP_Qb7IgF4loGtl50FE1LtK-W_xBimLfwkRsZShuUhN2H4XnhlJK4Ds-A*
>>>>>>> fa2a7ca9c83164580a3147451e8ce27862ff6a47


Skin development starts immediately after gastrulation at week 3. The ectoderm further develops to the nervous system and skin epithelium. the epidermal differentiation of these ectoderm cells is illustrated by gene expression of keratins. Adhered cells (periderm) creattes a protective layer for the ectoderm at weeks 4 to 8. Antigen presenting immune cells, the Langerhans cells, are noteable at week 6 (Hu; 2018).

*Quellen:https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6150059/pdf/kogg-14-01-1421882.pdf*

The skeletal muscles, e.g. some head muscles differentiate form mesoderm. First myotubes with central nuclei, where created by the fusion of myotubes between week 10 to 13. Typical muscle proteins develop in the follwing weeks (Romero; 2013). 

*Quellen:https://www.sciencedirect.com/science/article/abs/pii/B9780444595652000022?via%3Dihub*
...
Tissues specific antigens (TRAs) are important for the analysis of our dataset. TRAs are connected to the negative selection in thymus, which prevents an immune reaction against selfantigens. TRAs are ordered in clusters and controlled by autoimmune regulator (AIRE) in medullary epithelial cells (mTECs) and represent the diversity of antigens in our different tissues (Dinkelacker, 2019; Janeway Immunologie).We use the definition that TRAs are genes, which are expressed more than 5 times the median in less than 5 different tissues (Dinkelacker, 2019). The role of TRAs is the target of this report.

*Quellen: Dinkelackers Doktorarbeit, Janeway Immuno*
...
all_libraries <- tibble::tribble(
  ~Library...package,                        ~Version, 
              "affy",                              NA, 
               "vsn",                              NA, 
     "AnnotationDbi",                              NA, 
         "tidyverse", "library used for Datacleaning", 
           "Version",                   "Description"
...
scatterplot.GSE15744.vsnrma <- ggplot(data = exprs.GSE15744.vsnrma) +
  ...
  labs(title = paste(" Scatterplot of microarray\n", substr(colnames(data.GSE15744.vsnrma)[4], 1, nchar(colnames(data.GSE15744.vsnrma)[4])), "and", substr(colnames(data.GSE15744.vsnrma)[5], 1, nchar(colnames(data.GSE15744.vsnrma)[5])), "in week 5", sep=" ", collapse = NULL),
...
The *limma* package is installed and imported using bioconductor. Among many other things, it determines changes of gene expression over time in intensity values of microarrays, so called differential expressed genes. It facilitates advanced statistical algorithms to calculate the necessary coefficients of a linear model for every intensity value in the data set. It does this by utilizing information borrowing, quantitative weighting, variance modelling and data preprocessing, but importantly, it does not subset the data. doi: 10.1093/nar/gkv007. Because the same linear model was performed on every intensity value, statistical tests called Empirical Bayes can determine differential expressed genes via t-statistics and their associated p-values, while reducing the variance of residuals. 
...
To filter our data for biological interesting data, we performed *limma* analysis to extract differentially expressed genes. Our threshold for significance is an Benjamini-Hochberg adjusted p-value of 0.01 or below. We found changes of gene expression in 1,814 transcrips 
...
paper_df_intersec <- paper_df_ann %>% drop_na(ensembl.transcript)
...
```{r paper-trends-cluster, fig.width=17, fig.height=3.5, fig.cap = "Clustering of the common transcripts reveals similar trends. We chose data with transcript IDs both in the data set of the original paper and in our TRA data. Additionally they had to be annotated as *up, *down*, or *arch* by the authors of the paper. The *up* and *down* regulated transcript-data (A and B) follow the same pattern as postulated in the paper. For the *arch* regulated transcript-data (C) we see clusters, with same matching the *arch* pattern and some who are rather undetermined."}
...
paper_df_diff_list = list(as.data.frame(paper_df_up),as.data.frame(paper_df_down),as.data.frame(paper_df_arch))
# Select an modify the data used for kmeans
i = 0
names <- c("Up-regulated", "Down-regulated","Arch-regulated")
for (data_temp in paper_df_diff_list){
  i= i+1
data_abs = data.frame(Week4 = apply(data_temp[8:10], 1, median), Week5 =  apply(data_temp[11:13], 1, median), Week6 =  apply(data_temp[14:16], 1, median),
                        Week7=apply(data_temp[17:19], 1, median), Week8 =  apply(data_temp[20:22], 1, median), Week9 =  apply(data_temp[23:25], 1, median))
...
assign(str_glue( "plot_", i), ggplot(plot_data, aes(x = Week, y= Expression, group = Cluster))  + geom_line(aes(colour = Cluster)) +geom_point(aes(colour = Cluster, shape = Cluster)) + labs(title = names[i]) + scale_color_npg() + theme_classic()  + ylim(6.5,8.5) + theme(aspect.ratio = 1))
}

Paper_clustering_plot = arrangeGrob(grobs = list(plot_1, plot_2, plot_3),
                                    nrow=1, widths = c(5,5,5), heights = c(3.5))

Paper_clustering_plot_output = as_ggplot(Paper_clustering_plot) +
  draw_plot_label(label = c("A", "B", "C"), size = 15, x = c(0.01, 0.37, 0.68), y = c(0.13, 0.13, 0.13)) 

annotate_figure(Paper_clustering_plot_output, top = text_grob("Intensity values of transcripts determined to be\ndifferentially expressed by the paper", color = "black", face = "bold", size = 16))
```
...
This visualization helps to determine how many PCAs are needed to explain a significant amount of the data's variation. The chosen PCAs can than be used for further analysis. The first three PCAs already explain over 80% of the data's variance (Figure \@ref(fig:pca-variance)). Only those three were chosen to be used for further analysis and visualization.
...
```
For further analyzation, each transcript was awarded a rank depending on how much it contributes to the specific PCA. We took a closer look at the five first-ranking transcripts of PCA1, as this PCA alone already explains over 60% of the variety of our data. These five transcripts with the highest contribution encode for: Low-Density Lipoprotein Receptor Class A Domain-Containing Protein 4 (LDLRAD4) encoded by ENST00000399848, Calcium-activated potassium channel subunit beta-2 (KCNMB2) encoded by ENST00000432997 and ENST00000452583 and SLIT And NTRK-Like Protein 3 (SLITRK3) encoded by ENST00000241274 and ENST00000475390.
```{r}
PCA1_first_five <- diff_genes_ann_0.01[c('9703','11797','13044','616','15025'),0:19]

rep1 <- data.frame(t(PCA1_first_five[,c(1,4,7,10,13,16)]))
rep2 <- data.frame(t(PCA1_first_five[,c(2,5,8,11,14,17)]))
rep3 <- data.frame(t(PCA1_first_five[,c(3,6,9,12,15,18)]))


#plotting the expression of the five most contributing transcripts for each chip
par(mfrow = c(1, 3))

#rep1 first 5 transcripts expression over weeks
matplot(rep1, type = 'b',pch=16,col = c('black','red','green','blue','orange'), xlab = 'Weeks', ylab = 'Expression level', main = 'replica 1' , xaxt='n')
axis(side = 1, at = 1:6, labels = c(4,5,6,7,8,9))
legend('bottomright', legend = c('ENST00000399848','ENST00000432997','ENST00000452583','ENST00000241274','ENST00000475390'), col=c('black','red','green','blue','orange'), pch=16, cex=0.8,title="Expressed genes")
theme(aspect.ratio = 1)

#rep2 first 5 transcripts expression over weeks
matplot(rep2, type = 'b',pch=16,col = c('black','red','green','blue','orange'), xlab = 'Weeks', ylab = 'Expression level', main = 'replica 2' , xaxt='n')
axis(side = 1, at = 1:6, labels = c(4,5,6,7,8,9))
legend('bottomright', legend = c('ENST00000399848','ENST00000432997','ENST00000452583','ENST00000241274','ENST00000475390'), col=c('black','red','green','blue','orange'), pch=16, cex=0.8,title="Expressed genes")
theme(aspect.ratio = 1)

#rep3 first 5 transcripts expression over weeks
matplot(rep3, type = 'b',pch=16,col = c('black','red','green','blue','orange'), xlab = 'Weeks', ylab = 'Expression level', main = 'replica 3' , xaxt='n')
axis(side = 1, at = 1:6, labels = c(4,5,6,7,8,9))
legend('bottomright', legend = c('ENST00000399848','ENST00000432997','ENST00000452583','ENST00000241274','ENST00000475390'), col=c('black','red','green','blue','orange'), pch=16, cex=0.8,title="Expressed genes")
theme(aspect.ratio = 1)
```
The transcripts ENST00000432997 and ENST00000452583 encode for the same Protein (KCNMB2). Fitting to that, both transcripts consistently display the same expression levels over all weeks for all three different replicas. The same applies to the transcripts ENST00000241274 and ENST00000475390, as they also encode for the same protein (SLITRK3). 
The transcripts for LDLRAD4 show the highest overall expression levels. Their expression levels also don't display many similarities to those of KCNMB2 and SLITRK3, as their increase patterns differ. However, KCNMB2 and SLITRK3 show great similarity in their expression levels for all three replicas over all weeks. Especially replica three shows near identical expression patterns of KCNMB2 and SLITRK3 between weeks 5 to 8.
...
```{r gene-expression-brain,fig.height=5,fig.width=12,fig.cap="Geneexpression of different genes for ion channel (left), neuronal development and function (middle) and cytokine (right) was plotted for week 4 to 9"}
...
```{r tissue-links,fig.width=9, fig.height=7, fig.subcap= "Each tissue is displayed as a node with its size representing the number of transcripts associated with it. The edges show the shared TRAs between the linked tissues, with only links corresponding to more than 100 common TRAs visible."}
library(igraph)
library(tidyverse)
library(ggnet)
library(viridis)
...
As shown in Fig. ???, the spleen is a clear example of two dinstict clusters with one consisting of upregulated previously inactive genes and one with downregulated highly active genes. For all these differentially expressed  transcripts, we used the NCBI gene database to get a functional annotation. 
...
table_spleen1 = gt(spleen1_gene_description_sum)|>  tab_header(title= "Spleen - Upregulated", subtitle = "List of differentially epxressed genes") |> fmt_markdown(columns = c(Transcript, Gene, Protein, Summary)) |> gt_theme_538() |> gt_plt_sparkline( column = Expression_over_time, type = "ref_median")
table_spleen1
```
...
```{r, fig.width=12}
# Table for downregulated genes # Jetzt noch für Spleen2
library(gt)
library(gtExtras)
library(ggplot2)
library(tidyverse)
...
First point to discuss is the significant increase in the gene expression of Ca(2+)ATPase (SLN sarcolipin) by factor 2 in logarithmic scale. A cause of this is the process of neuronal migration which starts at week 9. Ca(2+) is an important cofactor for actin dependent cell migration.

Another point is the strong correlation between the expression of SNAP91 genes and one SYBU gene (ENST00000276646). Both proteins were associated with the Cerebellar Hemisphere and contribute to endocytosis, which is essential for functional neurons and contributes to neuronal survival (Overhoff, 2020). One point to mention here is, that ENST00000521485 and ENST00000518312 were both associated with SNAP91, nevertheless to different isoforms. But both show identical correlation in expression, hence a failure in annotation might be possible.

*Quelle:<https://onlinelibrary.wiley.com/doi/10.1111/jnc.15194>*

In addition we identified a significant increase in expression of NXPH1, this refers to the NXPH1-promoted adhesion between axons and dendrites. An upregulation of this supplementary factor can prepare the process of synapse formation which starts at week 11.

We further identified that two transcripts associated to two different tissues show identical correlation, this can be caused by false annotations. Nevertheless, they show a strong downregulation of BDNF. This factor normally promotes neuronal survival. A downregulation of BDNF can be a preparation for the phase of programmed cell death, which starts at week 20 in neuronal development.
