...
```{r, fig.width=14, fig.height=14, include = FALSE, eval = FALSE}
library(pheatmap)
...
```{r, fig.width = 12, fig.height = 7, fig.cap = "This is just a test..."}
plot_spleen_up = ggdraw() + draw_image("spleen_up.png")
grid.arrange(plot_spleen_up)
```
...
```{r, fig.width = 12, fig.height = 16, fig.cap = "This is just a test..."}
plot_spleen_down = ggdraw() + draw_image("spleen_down.png")
grid.arrange(plot_spleen_down)
```
