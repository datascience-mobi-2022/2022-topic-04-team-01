...
```{=latex}
\begin{table}[htb]
\caption{Table 1: All libraries nessecary for the code of this report installed from CRAN, Bioconductor and brainarray}
\resizebox{\textwidth}{!}{
...
OC_chip_plot = arrangeGrob(grobs = list(surface_image_plot, RNA_degradation_plot),
                                    nrow=1, widths = c(4,4), heights = c(4))
