...
boxplot(data.GSE15744, col = rainbow(15),
        ...
        main="Raw Gene expression in human embryo (GSE27830, raw data)")

dev.copy2pdf(file="C:/Users/david/Documents/Data Analysis Lokal/Plots/Boxplot_GSE27830_Raw-Data.pdf")
...
boxplot(exprs(GSE15744.vsnrma), col = rainbow(15),
        ...
        las=2,                                            # Vertical x-axis text
        ylab="Relative expression",
        main="Raw Gene expression in human embryo (GSE27830, normalized)")

dev.copy2pdf(file="C:/Users/david/Documents/Data Analysis Lokal/Plots/Boxplot_GSE27830_normalized.pdf")
```
...
dev.copy2pdf(file="C:/Users/david/Documents/Data Analysis Lokal/Plots/Histogramm_GSE27830_Raw-Data.pdf")
...
dev.copy2pdf(file = "C:/Users/david/Documents/Data Analysis Lokal/Plots/Histogramm_GSE27830_vsnnormalized.pdf")
```
...
title(sub="Human embryo (GSE27830, Raw data)")

dev.copy2pdf(file="C:/Users/david/Documents/Data Analysis Lokal/Plots/RNAdeg_GSE27830_raw.pdf")

# Not scaled
plotAffyRNAdeg(rnadeg.raw, col=rainbow(10), transform = "shift.only")
title(sub="Human embryo (GSE27830, Raw data)")

dev.copy2pdf(file="C:/Users/david/Documents/Data Analysis Lokal/Plots/RNAdeg_GSE27830_raw_unscaled.pdf")
...
for(i in 1:17){
  ...
  file.name <- paste("C:/Users/david/Documents/Data Analysis Lokal/Plots/Scatterplots/Scatterplot_GSE27830.pdf", 
