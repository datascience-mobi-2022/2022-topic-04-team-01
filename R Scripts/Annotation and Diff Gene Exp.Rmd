...
library(affy)
setwd("C:/Users/david/Documents/Data Analysis Lokal/Raw-Data/GSE15744_RAW")
gse.exp = ReadAffy()
...
```{r}
setwd("C:/Users/david/Documents/Data Analysis Lokal/2022-topic-04-team-01/R Scripts/Paul Exploratory + Stuff")
load("embryo_df_ann.RData")
embryo_df_ann
```
